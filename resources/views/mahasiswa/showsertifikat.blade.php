        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    <h1 class="h3 mb-0 text-gray-800">Edit berkas</h1>
                </div>

                <form action="{{ route('UpdateSertifikat') }}" class="m-5" method="POST" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" name='userid' value="{{ auth()->user()->id }}">
                    <input type="hidden" name='sertifikatid' value="{{ $lama->id }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="nama_kegiatan" id="nama_kegiatan" class="form-control form-control-user"
                            id="exampleInputEmail"
                            placeholder="Masukan judul kegiatan atau deskripsi singkat tentang sertifikat..."
                            value="{{ $lama->nama_kegiatan }}">
                    </div>
                    <div class="form-group xl-5">
                        ...
                        value="{{ $lama->tanggal_kegiatan }}" onkeydown="return false">
                    </div>
                    <div class="form-group">
